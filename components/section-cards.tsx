  ...
  return (
    <div className={`${dashboardStatsGrid} ${mobileInset}`}>
        ...
        <div className="relative bg-emerald-50 dark:bg-slate-900 rounded-xl sm:rounded-2xl p-3 sm:p-5 transition-all duration-300 group-hover:shadow-lg border border-transparent hover:border-emerald-200 dark:hover:border-slate-600 h-full">
          <div className="flex items-start justify-between mb-2 sm:mb-4">
            <div className="p-2 sm:p-3 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-lg sm:rounded-xl shadow-lg group-hover:scale-110 transition-transform duration-300">
              <DollarSignIcon className="size-4 sm:size-6 text-white" />
            </div>
            <div className={`flex items-center gap-1 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-lg text-[10px] sm:text-xs font-bold bg-emerald-100 dark:bg-emerald-900/30 ${stats.revenueTrend >= 0 ? 'text-emerald-600 dark:text-emerald-400' : 'text-rose-600 dark:text-rose-400'}`}>
          ...
          <p className="text-[11px] sm:text-sm font-medium text-slate-600 dark:text-slate-400 mb-1">کۆی داهات</p>
          <h3 className="text-lg sm:text-2xl font-bold text-slate-900 dark:text-white mb-2 sm:mb-4">{formatCurrency(stats.totalRevenue)}</h3>
        ...
        <div className="relative bg-blue-50 dark:bg-slate-900 rounded-xl sm:rounded-2xl p-3 sm:p-5 transition-all duration-300 group-hover:shadow-lg border border-transparent hover:border-blue-200 dark:hover:border-slate-600 h-full">
          <div className="flex items-start justify-between mb-2 sm:mb-4">
            <div className="p-2 sm:p-3 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-lg sm:rounded-xl shadow-lg group-hover:scale-110 transition-transform duration-300">
              <CalendarIcon className="size-4 sm:size-6 text-white" />
            </div>
            <div className={`flex items-center gap-1 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-lg text-[10px] sm:text-xs font-bold bg-blue-100 dark:bg-blue-900/30 ${stats.appointmentTrend >= 0 ? 'text-blue-600 dark:text-blue-400' : 'text-rose-600 dark:text-rose-400'}`}>
          ...
          <p className="text-[11px] sm:text-sm font-medium text-slate-600 dark:text-slate-400 mb-1">کۆی موچەی کارمەندەکان</p>
          <h3 className="text-lg sm:text-2xl font-bold text-slate-900 dark:text-white mb-2 sm:mb-4">{formatCurrency(stats.totalSalaries)}</h3>
          <div className="space-y-2">
            <div className="flex items-center justify-between p-1.5 sm:p-2 rounded-lg bg-slate-50 dark:bg-slate-800">
              <div className="flex items-center gap-2">
      ...
      <div className="relative group">
        ...
        <div className="relative bg-rose-50 dark:bg-slate-900 rounded-xl sm:rounded-2xl p-3 sm:p-5 transition-all duration-300 group-hover:shadow-lg border border-transparent hover:border-rose-200 dark:hover:border-slate-600 h-full">
          <div className="flex items-start justify-between mb-2 sm:mb-4">
            <div className="p-2 sm:p-3 bg-gradient-to-r from-rose-500 to-pink-500 rounded-lg sm:rounded-xl shadow-lg group-hover:scale-110 transition-transform duration-300">
              <DollarSignIcon className="size-4 sm:size-6 text-white" />
            </div>
            <div className="flex items-center gap-1 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-lg text-[10px] sm:text-xs font-bold bg-rose-100 dark:bg-rose-900/30 text-rose-600 dark:text-rose-400">
              داهات
            </div>
          </div>
          <p className="text-[11px] sm:text-sm font-medium text-slate-600 dark:text-slate-400 mb-1">کۆی داهاتی فرۆشتن</p>
          <h3 className="text-lg sm:text-2xl font-bold text-slate-900 dark:text-white mb-2 sm:mb-4">{formatCurrency(stats.salesRevenue)}</h3>
          <div className="space-y-2">
            <div className="flex items-center justify-between p-1.5 sm:p-2 rounded-lg bg-slate-50 dark:bg-slate-800">
              <div className="flex items-center gap-2">
                <CalendarIcon className="size-3.5 text-slate-500 dark:text-slate-400" />
      ...
      <div className="relative group">
        ...
        <div className="relative bg-amber-50 dark:bg-slate-900 rounded-xl sm:rounded-2xl p-3 sm:p-5 transition-all duration-300 group-hover:shadow-lg border border-transparent hover:border-amber-200 dark:hover:border-slate-600 h-full">
          <div className="flex items-start justify-between mb-2 sm:mb-4">
            <div className="p-2 sm:p-3 bg-gradient-to-r from-amber-500 to-orange-500 rounded-lg sm:rounded-xl shadow-lg group-hover:scale-110 transition-transform duration-300">
              <CreditCardIcon className="size-4 sm:size-6 text-white" />
            </div>
            <div className="flex items-center gap-1 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-lg text-[10px] sm:text-xs font-bold bg-amber-100 dark:bg-amber-900/30 text-amber-600 dark:text-amber-400">
              چاوەڕوان
            </div>
          </div>
          <p className="text-[11px] sm:text-sm font-medium text-slate-600 dark:text-slate-400 mb-1">قەرزی مانگانە</p>
          <h3 className="text-lg sm:text-2xl font-bold text-slate-900 dark:text-white mb-2 sm:mb-4">{formatCurrency(stats.pendingInstallmentsAmount)}</h3>
          <div className="space-y-2">
            <div className="flex items-center justify-between p-1.5 sm:p-2 rounded-lg bg-slate-50 dark:bg-slate-800">
              <div className="flex items-center gap-2">
